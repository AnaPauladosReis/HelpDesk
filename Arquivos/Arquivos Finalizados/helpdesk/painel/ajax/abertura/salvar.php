...
// Se for abertura pública (sem sessão), pega automaticamente o primeiro usuário existente
if ($usuario_abertura_id <= 0) {
    ...
    $usuario_abertura_id = (int)($stUser->fetchColumn() ?: 0);

    if ($usuario_abertura_id <= 0) {
        out(false, "Nenhum usuário encontrado no sistema para vincular o chamado. Cadastre ao menos um usuário.");
    }
}
