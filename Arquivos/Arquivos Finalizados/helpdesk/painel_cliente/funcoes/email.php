...
function enviarEmailPadrao(
    ...
    try {
        ...
        // Remetente
        // Remetente sempre igual ao usuário SMTP (compatível com Gmail, Outlook, Hostgator, etc)
        $mail->setFrom($smtpUser, $deNome);

        // Reply-To fica o email configurado do sistema
